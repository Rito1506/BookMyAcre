...
var import_optional_peer_dep___vite_optional_peer_dep_vue_router_vite_ssg = (/* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {};
	throw new Error(`Could not resolve "vue-router" imported by "vite-ssg". Is it installed?`);
})))();
...
var ClientOnly = /* @__PURE__ */ defineComponent({ setup(props, { slots }) {
...
function ViteSSG(App, routerOptions, fn, options) {
	...
	async function createApp$1(routePath) {
		...
		let head;
		if (useHead) app.use(head = import.meta.env.SSR ? /* @__PURE__ */ createHead() : /* @__PURE__ */ createHead$2());
		const router = (0, import_optional_peer_dep___vite_optional_peer_dep_vue_router_vite_ssg.createRouter)({
			history: import.meta.env.SSR ? (0, import_optional_peer_dep___vite_optional_peer_dep_vue_router_vite_ssg.createMemoryHistory)(routerOptions.base) : (0, import_optional_peer_dep___vite_optional_peer_dep_vue_router_vite_ssg.createWebHistory)(routerOptions.base),
			...routerOptions
		});
